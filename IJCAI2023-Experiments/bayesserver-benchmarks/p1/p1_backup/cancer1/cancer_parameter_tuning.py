...
parameters_to_test = []
parameters_to_test.append(ParameterReference(Cancer, [Pollutionhigh,SmokerTrue,CancerTrue]))
parameters_to_test.append(ParameterReference(Xray, [CancerTrue,Xraypositive]))
